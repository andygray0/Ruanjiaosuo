...
public class NoAuthorityController {
    ...
    public void getValidCode(HttpServletRequest request, HttpServletResponse response) throws Exception{
...
//设置不缓存图片
        ...
        for(int i=0;i<4;i++){
            ...
            g.drawString(ctmp, 15*i+18, 7);
        }
        HttpSession session=request.getSession(true);
        session.setAttribute(Constants.CURRENT_VALID_CODE, sRand.toUpperCase());
