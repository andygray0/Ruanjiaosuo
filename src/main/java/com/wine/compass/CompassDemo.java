...
public class CompassDemo extends JPanel {
    ...
    /** The chart. */
    private JFreeChart compassChart = new JFreeChart("Compass Test", JFreeChart.DEFAULT_TITLE_FONT,
    ...
    /** A combo box. */
    private JComboBox pick1Pointer = new JComboBox(CompassDemo.NEEDLE_TYPES);

    /** A panel. */
    private JPanel jPanel2 = new JPanel();

    /** A combo box. */
    private JComboBox pick2Pointer = new JComboBox(CompassDemo.NEEDLE_TYPES);
    ...
    public JFreeChart getCompassChart() {
		return compassChart;
	}

	public void setCompassChart(JFreeChart compassChart) {
		this.compassChart = compassChart;
	}
    ...
    public static void main(final String[] args) {
        ...
        try {
			ChartUtilities.saveChartAsJPEG(new File("/home/hok/temp/compass.jpg"), panel.getCompassChart(), 700, 400);
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
     ...
     * @param e  the event.
     */
    public void checkWindNullActionPerformed(final ActionEvent e) {
     ...
     * @param e  the event.
     */
    public void checkShipNullActionPerformed(final ActionEvent e) {
        if (CompassDemo.DEBUG) {
     ...
     * @param e  the event.
     */
    public void pick2PointerActionPerformed(final ActionEvent e) {
      if (CompassDemo.DEBUG) {
     ...
     * @param e  the event.
     */
    public void pick1PointerActionPerformed(final ActionEvent e) {
        if (CompassDemo.DEBUG) {
