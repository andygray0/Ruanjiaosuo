$(function() {
    ...
    $("button[type='button']").click(function(){
        ...
        $.post(contextPath + '/admin/login.html',data,callback);
       
    });
    function callback(result) {
    	if(result.error) {
    		$("#loginError").css({display:'block'}).text(result.error);
    		return;
    	}
//    	location.href = contextPath + "/page/admin/profile/profile.jsp";
    	location.href = contextPath + "/admin/profile.html";
