var YDataWenjuanGrid = function(config){
    debugger;
		config = config || {};
		...
		var Handler = {
			...
			save : function(beforeSubmit,callback) {
                ...
                //alert(11111111111+"  = "+formUrl+" = "+uploadUrl);
		...
		var initGrid = function(){
			var dataconfig = {
				...
				onDblClickRow:function(rowIndex,rowData){
                       debugger;
                      $.ajax({
                           url:'../../../showHighCharts.do?id='+rowData.id,
                           dataType:'json',
...
//饼图展示
function showHighCharts(dataSource){

    $('#reportCharts').highcharts({
            chart: {
