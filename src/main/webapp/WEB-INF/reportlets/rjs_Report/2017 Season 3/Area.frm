...
<Query>
<![CDATA[select * from lxty.2016_2017_season3_area_bid_amount]]></Query>
</TableData>
...
<Query>
<![CDATA[select * from lxty.2017_season3_soft_know_city]]></Query>
</TableData>
...
<Query>
<![CDATA[select * from lxty.2017_season3_bid_bidding_province]]></Query>
</TableData>
...
<Query>
<![CDATA[select * from lxty.2016_2017_season3_area_bidding_amount]]></Query>
</TableData>
	...
	(
		...
		WHERE
			(
				...
				AND (
					`radar2`.`URLCONTENT_INFO_SOFT_EFFECTIVE_20171`.`IR_URLmonth` IN (1, 2, 3, 4, 5, 6,7,8)
				)
...
<BoundsAttr x="238" y="187" width="104" height="98"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<Attr showLine="false" autoAdjust="true" position="0" isCustom="false"/>
<TextAttr>
<Attr alignText="0">
<FRFont name="宋体" style="0" size="72"/>
</Attr>
...
<BoundsAttr x="6" y="338" width="570" height="301"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.container.WTitleLayout">
...
<BoundsAttr x="6" y="30" width="570" height="300"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<BoundsAttr x="2" y="3" width="1147" height="25"/>
</Widget>
<Sorted sorted="false"/>
<MobileWidgetList>
