...
<body>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $.get("/reportMenu/findAllMenus.do",{},function (data) {
        ...
        function zTreeOnClick(event, treeId, treeNode) {
            ...
            $("#right-main-content-div").load("/reportMenu/getMenuById.do", {id : treeNode.id});
        }
            ...
            if(treeNode.menuLevel < 2){
                ...
                if (btn) btn.bind("click", function(){
                    showModalDialog({
                        title : '新增',
                        id : 'myModal',
                        url : '/reportMenu/addOrUpdateMenuForm.do?pid=' + treeNode.id + "&parentMenuName=" + treeNode.name,
                        operate : 'insert',
                        btnText : '保存',
        ...
        function zTreeBeforeRemove(treeId, treeNode) {
            ...
            if(result){
                ...
                $.post("/reportMenu/deleteMenu.do", {"ids" : ids}, function (data) {
                    console.info(data);
                });
            }
        ...
        function saveRoleMenu() {
            ...
            if("" == $("#id").val()){ // 新增
                $.post("/reportMenu/saveMenu.do",params, function (data) {
                ...
                if(flag){ // 数据发生了变化
                    // 修改
                    $.post("/reportMenu/updateMenu.do", params, function (data) {
                        $("#right-main-content-div").load("/reportMenu/getMenuById.do", {id : $("#id").val()});
                    ...
                    name: {
                        validators: {
                            ...
                            remote: {////ajax验证。服务器端返回的 result:{"valid" : false} 向服务发送当前input name值，获得一个json数据。例表示正确：{"valid" : true}
                                url: "/reportMenu/validUniqueFieldComplex.do?field=name&pid=" + $("#pid").val() + "&operate=" + $("#saveMenuBtn").attr("data-operate") + "&id=" + $("#id").val(),
                                type:"GET",
